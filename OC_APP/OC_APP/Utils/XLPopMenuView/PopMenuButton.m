...
- (void)selectdAnimation
{
    if (_model.transitionType == PopMenuTransitionTypeSystemApi) {
        ...
        UIColor* color = [UIColor xl_getPixelColorAtLocation:CGPointMake(50, 20) inImage:image];
...
- (void)setModel:(PopMenuModel*)model
{
    ...
    UIColor* color = [UIColor xl_getPixelColorAtLocation:CGPointMake(image.size.width / 2, image.size.height / 2) inImage:image];
