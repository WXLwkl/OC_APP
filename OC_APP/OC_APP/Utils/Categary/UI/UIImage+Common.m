...
- (UIImage *)xl_imageByRoundCornerRadius:(CGFloat)radius {
    return [self xl_imageByRoundCornerRadius:radius borderWidth:0 borderColor:nil];
}

- (UIImage *)xl_imageByRoundCornerRadius:(CGFloat)radius
                          borderWidth:(CGFloat)borderWidth
                          borderColor:(UIColor *)borderColor {
    return [self xl_imageByRoundCornerRadius:radius
...
- (UIImage *)xl_imageByBlurSoft {
    return [self xl_imageByBlurRadius:60 tintColor:[UIColor colorWithWhite:0.84 alpha:0.36] tintMode:kCGBlendModeNormal saturation:1.8 maskImage:nil];
}

- (UIImage *)xl_imageByBlurLight {
    return [self xl_imageByBlurRadius:60 tintColor:[UIColor colorWithWhite:1.0 alpha:0.3] tintMode:kCGBlendModeNormal saturation:1.8 maskImage:nil];
}

- (UIImage *)xl_imageByBlurExtraLight {
    return [self xl_imageByBlurRadius:40 tintColor:[UIColor colorWithWhite:0.97 alpha:0.82] tintMode:kCGBlendModeNormal saturation:1.8 maskImage:nil];
}

- (UIImage *)xl_imageByBlurDark {
    return [self xl_imageByBlurRadius:40 tintColor:[UIColor colorWithWhite:0.11 alpha:0.73] tintMode:kCGBlendModeNormal saturation:1.8 maskImage:nil];
}
...
- (UIImage *)xl_imageByBlurWithTint:(UIColor *)tintColor {
    ...
    return [self xl_imageByBlurRadius:20 tintColor:effectColor tintMode:kCGBlendModeNormal saturation:-1.0 maskImage:nil];
}
...
- (UIImage *)xl_applyLightEffect {
    ...
    return [self xl_applyBlurWithRadius:30 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}

- (UIImage *)xl_applyExtraLightEffect {
    UIColor *tintColor = [UIColor colorWithWhite:0.97 alpha:0.82];
    return [self xl_applyBlurWithRadius:20 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
- (UIImage *)xl_applyBlurEffect {
    ...
    return [self xl_applyBlurWithRadius:8.0f tintColor:tintColor saturationDeltaFactor:1.8f maskImage:nil];
}
...
- (UIImage *)xl_applyTintEffectWithColor:(UIColor *)tintColor {
    ...
    return [self xl_applyBlurWithRadius:10 tintColor:effectColor saturationDeltaFactor:-1.0 maskImage:nil];
}
