...
static NSString * const kRequestManagerCache = @"RequestManagerCache";
static  YYCache *_dataCache;

@implementation RequestManagerCache

+ (void)initialize {
    _dataCache = [YYCache cacheWithName:kRequestManagerCache];
}
