...
- (UITableView *)tableView
{
    if (!_tableView)
    {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, 80, kScreenHeight)];
...
- (UICollectionView *)collectionView
{
    if (!_collectionView)
    {
        ...
        _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(2 + 80, 2 + 64, kScreenWidth - 80 - 4, kScreenHeight - 64 - 4) collectionViewLayout:flowlayout];
...
{
    return CGSizeMake((kScreenWidth - 80 - 4 - 4) / 3,
                      (kScreenWidth - 80 - 4 - 4) / 3 + 30);
}
