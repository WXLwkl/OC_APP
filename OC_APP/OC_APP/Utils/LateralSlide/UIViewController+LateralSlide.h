//
//  UIViewController+LateralSlide.h
//  cehua
//
...
@interface UIViewController (LateralSlide)
 ...
 */
- (void)xl_showDrawerViewController:(UIViewController *)viewController
                      animationType:(DrawerAnimationType)animationType
                      configuration:(LateralSlideConfiguration *)configuration;
 ...
 */
- (void)xl_registerShowIntractiveWithEdgeGesture:(BOOL)openEdgeGesture
                                       direction:(DrawerTransitionDirection)direction transitionBlock:(void(^)())transitionBlock;
