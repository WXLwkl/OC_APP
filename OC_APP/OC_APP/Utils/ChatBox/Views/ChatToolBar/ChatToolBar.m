...
- (RecordButton *)recordBtn {
    if (!_recordBtn) {
        _recordBtn = [[RecordButton alloc] init];
        __weak __typeof(self) weakSelf = self;
        
        _recordBtn.recordTouchDownAction = ^(RecordButton *recordButton) {
            NSLog(@"开始录音");
        ...
        _recordBtn.recordTouchUpInsideAction = ^(RecordButton *recordButton) {
            NSLog(@"完成录音");
        ...
        _recordBtn.recordTouchUpOutsideAction = ^(RecordButton *recordButton) {
            NSLog(@"取消录音");
            [recordButton setButtonStateWithNormal];
        ...
        //持续调用
        _recordBtn.recordTouchDragInsideAction = ^(RecordButton *recordButton) {
            
        };
        //持续调用
        _recordBtn.recordTouchDragOutsideAction = ^(RecordButton *recordButton) {
            
        };
        //中间状态 从TouchDragInside --> TouchDragOutside
        _recordBtn.recordTouchDragExitAction = ^(RecordButton *recordButton) {
            NSLog(@"将要取消录音");
        ...
        _recordBtn.recordTouchDragEnterAction = ^(RecordButton *recordButton) {
            NSLog(@"继续录音");
