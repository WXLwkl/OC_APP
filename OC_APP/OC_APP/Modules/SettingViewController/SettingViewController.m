...
@interface SettingViewController ()<GroupShadowTableViewDelegate,GroupShadowTableViewDataSource> ///<, UITableViewDataSource>
...
- (GroupShadowTableView *)tableView {
    if (!_tableView) {
        _tableView = [[GroupShadowTableView alloc] initWithFrame:self.view.bounds style:UITableViewStyleGrouped];
    }
    return _tableView;
}
